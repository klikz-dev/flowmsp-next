...
const symbolOptionsHazardousMaterials = [
	...
	'extended/Gas',
	'extended/Electric',
    'extended/A', 'extended/B', 'extended/C', 'extended/D',
    'extended/RoofAccess', 'extended/GenericHazard', 'extended/SprinklerConnection',
    'extended/StandpipeConnection', 'extended/TrussedRoof',
	'Hazardous_Materials/Class-1-Blasting-Agent-15', 'Hazardous_Materials/Class-1-Explosives-11', 'Hazardous_Materials/Class-1-Explosives-12', 'Hazardous_Materials/Class-1-Explosives-13', 
	'Hazardous_Materials/Class-1-Explosives-14', 'Hazardous_Materials/Class-1-Explosives-15', 'Hazardous_Materials/Class-1-Explosives-16', 'Hazardous_Materials/Class-1-Explosives', 
	'Hazardous_Materials/Class-2-Chlorine', 'Hazardous_Materials/Class-2-Flammable-Gas-21', 'Hazardous_Materials/Class-2-Flammable-Gas', 'Hazardous_Materials/Class-2-Flammable-Liquid', 'Hazardous_Materials/Class-2-Flammable-Solid', 
	'Hazardous_Materials/Class-2-Inhalation-Hazards-23', 'Hazardous_Materials/Class-2-Non-Flammable-Gas-22', 'Hazardous_Materials/Class-2-Oxygen-22', 
	'Hazardous_Materials/Class-3-Combustible', 'Hazardous_Materials/Class-3-Flammable', 'Hazardous_Materials/Class-3-Fuel-Oil', 'Hazardous_Materials/Class-3-Gasoline', 
	'Hazardous_Materials/Class-4-Dangerous-When-Wet', 'Hazardous_Materials/Class-4-Flammable-Solids', 'Hazardous_Materials/Class-4-Spontaneously-Combustible', 
	'Hazardous_Materials/Class-5-Organic-Peroxides-51', 'Hazardous_Materials/Class-5-Organic-Peroxides-52', 'Hazardous_Materials/Class-5-Oxidizers-51', 
	'Hazardous_Materials/Class-6-Infectious', 'Hazardous_Materials/Class-6-Inhalation-Hazards', 'Hazardous_Materials/Class-6-Poison-Gas', 'Hazardous_Materials/Class-6-Poisons', 'Hazardous_Materials/Class-6-Toxic-Gas', 'Hazardous_Materials/Class-6-Toxic', 
	'Hazardous_Materials/Class-7-Radioactive', 'Hazardous_Materials/Class-8-Acids', 'Hazardous_Materials/Class-8-Alkaline', 'Hazardous_Materials/Class-8-Corrosive', 'Hazardous_Materials/Class-9', 
	'Hazardous_Materials/Class-Other-DANGEROUS', 'Hazardous_Materials/Class-Other-HOT', 'Hazardous_Materials/Class-Other-Store-Away-From-Food', 'Hazardous_Materials/Class-Other-V2', 'Hazardous_Materials/Class-Other-V3', 'Hazardous_Materials/Class-Other'
];
...
export class AnnotatorContainer extends Component {
  ...
  renderSymbolDropdown() {
		...
		for (let ii = 0; ii < symbolOptionsHazardousMaterials.length; ii++) {
			const path = '/images/NASPGLib/' + symbolOptionsHazardousMaterials[ii] + '_256x256.png';
			...
			const image = {
			          ...
			          isSelected: symbolToolActive ? (this.state.symbolType === symbolOptionsHazardousMaterials[ii]) : false
			};			
			IMAGES.push(image);
		}
		  return (
				  ...
				  onClickThumbnail = {(index) => {
					    ...
					    this.setState({ symbolType: option,
					    				symbolPath: path
					    			});
					  }
				  }
        ...
        <div className="content">
          <div className="annotator-container">          	
            <div className="tool-bar">              
              <ButtonGroup>             
                {map(manipulationTools, tool => this.renderButton(tool, tool))}
              </ButtonGroup>
              ...
              <ButtonGroup>
                ...
                <Button
                  bsStyle="success"
                  onClick={() => this.props.onSave(this.json, this.svg, this.state.tags)}
                >
                  Save
                </Button>
              </ButtonGroup>
