...
class LoginContainer extends React.Component {
  constructor(props) {
    ...
    this.handleFlowMSPAccountFormSubmit =
      this.handleFlowMSPAccountFormSubmit.bind(this);
    this.handleFlowMSPAccountCreationSuccess =
      this.handleFlowMSPAccountCreationSuccess.bind(this);
    this.handleFlowMSPAccountCreationFailure =
      this.handleFlowMSPAccountCreationFailure.bind(this);
    this.loginUser = this.loginUser.bind(this);
    this.toggleModal = this.toggleModal.bind(this);
    this.showCreateFlowMSPAccountModal =
      this.showCreateFlowMSPAccountModal.bind(this);
  }
  ...
  handleFlowMSPAccountFormSubmit(form) {
    ...
    newState.modal.body = (
      <FlowMSPAccountForm
        handleFormSubmit={this.handleFlowMSPAccountFormSubmit}
        isFormSubmitting
      />
    );
    ...
    this.setState({
      modal: {
        ...
        body: (
          <div>
            <div>
              Account creation is success! Your username will be your email
              address, which you will be able to change later.
            </div>
  ...
  handleForgotPassword = () => {
    this.setState({
      modal: {
        ...
        body: (
          <ForgotPasswordForm
            handleFormSubmit={this.handleForgotPasswordFormSubmit}
          />
        ),
      },
    });
...
function mapDispatchToProps(dispatch) {
  return {
    loginUser: (credentials, successCallback, errorCallback) =>
    ...
    createCustomer: (form, successCallback, errorCallback) =>
      customerAPI.createCustomer(form, successCallback, errorCallback),
  };
}
