...
export function forgotPasswordResetRequest(data, showMessage) {
  axios
    .post(`${process.env.API_BASE_URL}/api/passwordresetrequest`, data, {})
    .then(function (response) {
      showMessage({
        status: "Success",
        message:
...
export function forgotPasswordReset(data, showMessage) {
  axios
    .post(`${process.env.API_BASE_URL}/api/completepasswordreset`, data, {})
    .then(function (response) {
      showMessage({
        status: "Success",
...
export function submitSignUpSecondary(data, showMessage, linkPart) {
  axios
    .post(
      `${process.env.API_BASE_URL}/api/registrationLink/${linkPart}/createSecondary`,
      data,
      {}
    )
    .then(function (response) {
...
export function validateLinkPart(showMessage, onSuccess, linkPart) {
  axios
    .get(
      `${process.env.API_BASE_URL}/api/registrationLink/${linkPart}/validate`,
      {}
    )
    .then(function (response) {
...
export function getUserFromLinkPart(showMessage, onSuccess, linkPart) {
  axios
    .get(
      `${process.env.API_BASE_URL}/api/registrationLink/${linkPart}/user`,
      {}
    )
    .then(function (response) {
