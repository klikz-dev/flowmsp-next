...
class BuildingData extends React.Component {
  ...
  render() {
    ...
    const building = this.props.location && this.props.location.building && (typeof(this.props.location.building) !== 'undefined')  ? this.props.location.building : null;
	const lastReviewedOn = building && building.lastReviewedOn ? moment.utc(building.lastReviewedOn, 'MM-DD-YYYY HH.mm.ss').tz(timeZone).format('YYYY-MM-DD HH:mm') : ' ';
	const originalPrePlan = building && building.originalPrePlan ? moment.utc(building.originalPrePlan, 'MM-DD-YYYY HH.mm.ss').tz(timeZone).format('YYYY-MM-DD HH:mm') : ' ';
    return (
      <div className="building-data-container section-container">
        <div className="section-header">
          Building Data
          {this.props.isPrePlanningMode && <Label bsStyle="info">Pre-planning</Label>}
        </div>
                ...
                {this.props.isPolygonDrawn ? (
                  ...
                  <div>
                    ...
                    <div className="preplanning-actions">
                      <Button onClick={this.props.onCancelPrePlan}>Cancel</Button>
                    </div>
                  </div>
                )}
              </div>
