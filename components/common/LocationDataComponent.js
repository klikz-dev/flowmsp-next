            ...
            {location ? (
              <div className="section-row">
                ...
                <div>
	                ...
	                <span>{location.storeyBelow && (`${location.storeyBelow}`)}</span>
	                </div>
                <div>
                  <label>Roof Area:&nbsp;</label>
                  <span>{location.roofArea && (`${location.roofArea} sq. ft.`)}</span>
                </div>
                <div>
                  <label>Required Flow:&nbsp;</label>
                  <span>{location.requiredFlow && (`${location.requiredFlow} gal/min`)}</span>
                </div>
              </div>
            ) : (
                    ...
                    <div className="preplanning-actions">
                      {
                        ...
                        <Button onClick={this.props.onRePlanStart}>Redraw</Button>
                      }
                      {
                        !this.props.reDrawPolygon && this.props.location  &&
                        <Button onClick={this.props.onRePlanSubmit}>Submit</Button>
                      }
