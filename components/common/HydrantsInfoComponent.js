        ...
        <div className="section-content">
          {this.props.selectedHydrants.map((hydrant, index) => (
            ...
            <div className="hydrant-image">
                <img src={util.getMarkerIcon(hydrant.isMine, hydrant.dryHydrant, hydrant.inService, hydrant.pinColor, true)} />
              </div>
              <div className="hydrant-details">
                ...
                <div>
                  ...
                  <span>{hydrant.hydrantFlowRate && hydrant.hydrantFlowRate.toLocaleString()}&nbsp;gal/min</span>
                </div>
                <div>
                  <label>Description:&nbsp;</label>
                  <span>{hydrant.hydrantNotes}</span>
                </div>
                {!hydrant.inService && <div>
                		<label>Not In Service Since {moment(hydrant.outServiceDate).format('YYYY-MM-DD')}</label>
                	</div>
                }
                {hydrant.dryHydrant && <div>
